<template>
  <el-container class="home_container">
    <el-header>
      <div class="home_title">智慧商业园区运营管理系统</div>
  ...
  <span class="el-dropdown-link home_userinfo">
    {{currentUserName}}<i class="el-icon-arrow-down el-icon--right home_userinfo"></i>
          ...
          <el-dropdown-menu slot="dropdown">
            ...
            <el-dropdown-item command="MyArticle">xxxx</el-dropdown-item>
            <el-dropdown-item command="MyHome">xxxx</el-dropdown-item>
    ...
    <el-container>
      ...
      <el-container>
        <el-main>
          ...
          <el-image v-if="this.$route.path=='/home'" :src="image"></el-image>
          <keep-alive>
...
<script>
  ...
  import jpg from '@/assets/home.png'
  export default{
    methods: {
